...
if(isset($_POST["submit"]))
{
	...
	$insert=mysqli_query($link, "INSERT INTO student VALUES('$studentID', '$password_hash','$email',
	'$name','$gender','$phone');");
...
<p class="text-white fs-2" style="font-family: 'Courier New', Courier, monospace; font-weight: 600;">Add Student</p>
...
<div class="input-group mb-3">	 <input type="text" name="studentID" id="studentID" required class="form-control form-control-lg bg-light fs-6" placeholder="student id"/><br /></div>
...
<div class="input-group mb-3">	<input type="text" name="status" id="any" value="student" readonly  class="form-control form-control-lg bg-light fs-6" /><br /></div>
...
<div class="form-check form-check-inline">	<input type="radio" name="gender" value="male">Male<br /></div> </div>
