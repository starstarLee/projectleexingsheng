...
{	
	...
	$insert=mysqli_query($link, "UPDATE admin SET ADMIN_ID ='$adminID', PASSWORD ='$password_hash', 
	EMAIL_ADDRESS='$email', NAME='$name', GENDER='$gender', PHONE ='$phone'
	...
	$query = mysqli_query($link, "SELECT * FROM admin WHERE ADMIN_ID ='{$_REQUEST['ADMIN_ID']}' ");
...
?>
			<table class="table table-striped ">
				<h1 class="item-align-center">Admin Data</h1>			
<form action='' method='post' id='form4'>
	...
	<tr>
		...
		<td><input type="text" name="adminid" id="any" value="<?php echo $adminID; ?>" required class="form-control form-control-lg bg-light fs-6"> </td>
	</tr>
	<tr>
		<td><label>PASSWORD</label></td>
		<td><input type="text" name="password" id="password" value="" required></td>
	</tr>
	<tr>
	...
	<tr>
	<td></td>
		<td colspan = 2> <input type='button' name='back' value='Back' id='back' onclick="window.location='viewAdmin.php'" class="btn btn-md btn-success w-100 fs-6"> </td>
	<tr>
</table>
</form>
