...
{	
	...
	$insert=mysqli_query($link, "UPDATE student SET STUDENT_ID ='$studentID', PASSWORD ='$password_hash',  EMAIL_ADDRESS='$email', 
	...
	$query = mysqli_query($link, "SELECT * FROM student WHERE STUDENT_ID ='{$_REQUEST['STUDENT_ID']}' ");
...
?>
				...
				<h1 class="item-align-center">Student Data</h1>	
		...
		<td><input type="text" name="studentid" id="studentid" value="<?php echo $studentID; ?>" required class="form-control form-control-lg bg-light fs-6"> </td>
	</tr>
	<tr>
	...
	<tr>
	<td> </td>
	<td colspan = 2>	 <input type='button' name='back' value='Back' id='back' onclick="window.location='viewStudent.php'" class="btn btn-md btn-success w-100 fs-6"> </td>
	</tr>
</table>
</form>
